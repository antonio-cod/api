...
async function addBarreirasAcessoColumns() {
  try {
    console.log("Conectando ao banco de dados...");

    // Lê o arquivo SQL
    const sqlScript = readFileSync(
      "./scripts/add-barreiras-acesso-columns.sql",
      "utf8"
    );

    console.log(
      "Executando script para adicionar colunas na tabela barreiras_acesso..."
    );
    ...
    if (successCount > 0) {
      console.log("\n🎉 Tabela barreiras_acesso atualizada com sucesso!");
